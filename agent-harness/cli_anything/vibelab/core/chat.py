"""WebSocket chat helpers for the VibeLab server."""
...
def send_message(
    ...
    """
    Connect to the VibeLab WebSocket, send a provider command, collect the full
...
def get_processing_sessions(client: VibeLab) -> List[Dict[str, Any]]:
...
def get_waiting_sessions_compact(client: VibeLab) -> List[Dict[str, Any]]:
...
def check_session_status(client: VibeLab, session_id: str, provider: str = "claude") -> Dict[str, Any]:
