"""
Settings / API key management operations against the VibeLab REST API.
"""
...
def list_api_keys(client: VibeLab) -> List[Dict[str, Any]]:
    """
...
def create_api_key(client: VibeLab, key_name: str) -> Dict[str, Any]:
    """
...
def delete_api_key(client: VibeLab, key_id: str) -> bool:
    """
