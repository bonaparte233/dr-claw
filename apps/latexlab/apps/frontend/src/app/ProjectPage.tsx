...
function loadLLMSettings(): LLMSettings {
  try {
    ...
    if (!raw) {
      return {
        ...DEFAULT_LLM,
        llmModel: getVibeLabProviderDefault(DEFAULT_LLM.llmModel),
      };
    }
    ...
    return {
      ...
      llmModel: normalizeVibeLabModel(parsed.llmModel, getVibeLabProviderDefault(DEFAULT_LLM.llmModel)),
    };
  } catch {
    return DEFAULT_LLM;
  }
    ...
    <div className="project-shell">
      ...
      <aside className="project-sidebar">
        <div className="sidebar-brand">
          <div className="brand-title">LatexLab</div>
        ...
        <div className="modal-backdrop" onClick={() => setCreateOpen(false)}>
          <div className="modal" onClick={(event) => event.stopPropagation()}>
            ...
            <div className="modal-actions">
              <button className="btn ghost" onClick={() => setCreateOpen(false)} disabled={creating}>{t('取消')}</button>
              <button className="btn" onClick={handleCreate} disabled={creating}>{creating ? t('创建中…') : t('创建')}</button>
            </div>
          </div>
        </div>
      )}
            ...
            <div className="modal-body">
              <div className="field">
                ...
                <select
                  ...
                  onChange={(e) => setSettingsForm((p) => ({ ...p, llmModel: normalizeVibeLabModel(e.target.value, p.llmModel) }))}
                >
